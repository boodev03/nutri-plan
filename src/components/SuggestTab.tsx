...
export function SuggestTab() {
  const { calculateNutritionGoals, nutritionGoals, loading, error } = useNutritionCalculator();
            ...
            <div className="h-full flex items-center justify-center">
              {loading ? (
                ...
                <div className="text-center text-gray-500">
                  ...
                  <p className="mt-2">Fill out the form to get your personalized nutrition goals</p>
                </div>
              )}
            </div>
          </div>
